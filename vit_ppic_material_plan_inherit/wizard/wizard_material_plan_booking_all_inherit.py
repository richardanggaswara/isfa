...
class wizard_material_plan_booking_all_inherit(models.TransientModel):
	_name = "vit.wizard_material_plan_booking_all_inherit"
	...
	booking_ids = fields.One2many('vit.ppic_material_booking', 'mp_id', string="Wizard Booking lines", related="material_plan_id.booking_ids")
